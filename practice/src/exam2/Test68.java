...
/*
    'delete' method accepts 2 parameters: delete(int start, int end), where start
    ...
    So, in this case, `sb.delete(0, 100);` is equivalent to `sb.delete(0, sb.length());` and this
    deletes all the characters from the StringBuilder object.
